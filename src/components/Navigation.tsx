...
export default function Navigation() {
  ...
  const navItems = [
    { path: '/', icon: Palette, label: 'Home' },
    { path: '/marketplace', icon: Store, label: 'Marketplace' },
    { path: '/artisans', icon: Hammer, label: 'Artisans' },
    { path: '/workshops', icon: GraduationCap, label: 'Workshops' },
    ...
    <>
      ...
      <nav className="md:hidden fixed bottom-0 w-full bg-white border-t border-gray-100 z-50">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="fixed right-4 bottom-24 flex items-center space-x-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2.5 rounded-full shadow-lg hover:shadow-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-300"
        >
          <UserCircle2 size={20} />
          <span className="font-medium">Admin</span>
        </a>
